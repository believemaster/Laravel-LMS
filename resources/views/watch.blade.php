      ...
      <div class="row gap-y text-center">
        ...
        <div class="col-12">
            ...
            @if ($lesson->getPrevLesson())
                <a href="{{ route('series.watch', ['series' => $series->slug, 'lesson' => $lesson->getPrevLesson()->id]) }}" class="btn btn-info btn-sm pull-left">Prev Lesson</a>
            @endif

            @if ($lesson->getNextLesson())
                <a href="{{ route('series.watch', ['series' => $series->slug, 'lesson' => $lesson->getNextLesson()->id]) }}" class="btn btn-info btn-sm pull-right">Next Lesson</a>
            @endif
        </div>
