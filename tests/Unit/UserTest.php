...
class UserTest extends TestCase
{
    ...
    public function test_can_check_id_user_has_completed_lesson()
    {
        $this->flushRedis();
    ...
    public function test_can_get_all_series_being_watched_by_user()
    {
        ...
        $user->complteLesson($lesson);
        $user->compelteLesson($lesson3);
    ...
    public function test_can_get_next_lesson_to_be_watched_by_user()
    {
        ...
        $user = factory(User::class)->create(['episode_number' => 100]);
        $lesson = factory(Lesson::class)->create();
        $lesson2 = factory(Lesson::class)->create([
            'series_id' => 1,
            'episode_number' => 200
        ...
        $this->assertEquals($lesson->id, $nextLesson->id);
